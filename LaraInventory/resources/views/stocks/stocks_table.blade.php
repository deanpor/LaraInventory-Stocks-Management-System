...
{{--                                                    If the stock is in stock show white color else show red color--}}
    ...
    <script>
        ...
        //trigger when there is a checkbox being checked
        function checkOne() {
            var selectedStocks = [];

            //search for the checkbox within the length if the checkbox is being checked, then push the stock id hold by the checkbox to an array name as selectedStocks[]
            ...
            //selectedStocksInput.value = selectedStocks.join(',');   // the join() method to concatenate the elements of the selectedStocks array into a single string.
                                                                    //The string is created by separating the elements with commas (,).
                                                                    //This results in a comma-separated list of selected stock IDs.
        }
            ...
            if (selectedStocks.length === 0) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        // the join() method to concatenate the elements of the selectedStocks array into a single string.
                        //The string is created by separating the elements with commas (,).
                        //This results in a comma-separated list of selected stock IDs.
