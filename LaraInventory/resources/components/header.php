                    ...
                    <div class="align-self-end overflow-auto" id="kt_brand_tabs">
                        ...
                        <div class="header-tabs overflow-auto mx-4 ms-lg-10 mb-5 mb-lg-0" id="kt_header_tabs"
                            ...
                            <ul class="nav flex-nowrap text-nowrap">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#kt_header_navs_tab_1">Products</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div data-kt-search-element="content"
                                ...
                                <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <a href="../../demo20/dist/pages/search/horizontal.html"
                    ...
                    <div class="d-flex align-items-center ms-1">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                            ...
                            <div class="row g-0">
                                <!--begin:Item-->
                                <div class="col-6">
                                    <a href="../../demo20/dist/apps/projects/budget.html"
                                ...
                                <!--begin:Item-->
                                <div class="col-6">
                                    <a href="../../demo20/dist/apps/projects/settings.html"
                                ...
                                <!--begin:Item-->
                                <div class="col-6">
                                    <a href="../../demo20/dist/apps/projects/list.html"
                                ...
                                <!--begin:Item-->
                                <div class="col-6">
                                    <a href="../../demo20/dist/apps/projects/users.html"
                            ...
                            <div class="py-2 text-center border-top">
                                <a href="../../demo20/dist/pages/user-profile/activity.html"
                    ...
                    <div class="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                            ...
                            <div class="menu-item px-5 my-1">
                                <a title='Update Information' data-bs-toggle='modal'
                                   data-bs-target='#modal-lg-1' class="menu-link px-5"
                                   href='../users/user_settings.php'
                                    <span>Users Update</span>
                                </a>
                            </div>

                            <div class="menu-item px-5 my-1">
                                <a title='Update Product' data-bs-toggle='modal'
                                   data-bs-target='#modal-lg-1'
                                   href="../users/user_change_password.php"
                                ...
                                function signOut() {
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            ...
                                            window.location.href = "../users/sign_out.php";
                                        }
                                    });
                                }</script>
                    ...
                    <div class="tab-content" data-kt-scroll="true" data-kt-scroll-activate="{default: true, lg: false}"
                                ...
                                <div class="menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold align-items-stretch flex-grow-1 px-2 px-lg-0"
                                    ...
                                    <div class="d-flex flex-column flex-lg-row gap-2">
                                        <a class="btn btn-sm btn-light-primary fw-bold"
                                           href="../products/products_table.php">Show Product</a>
                                        <a title='Add Product' data-bs-toggle='modal'
                                           data-bs-target='#modal-lg-1' class="btn btn-sm btn-light-success fw-bold"
                                           href="../products/add_product.php">Add A Product</a>
                                        <a class="btn btn-sm btn-light-danger fw-bold"
                                           href="../products/show_deleted_products.php">Show All Deleted Products</a>
                                    </div>
                                    <!--end:Menu item-->
                                </div>
                                <!--end::Menu-->
                        ...
                        <div class="tab-pane fade" id="kt_header_navs_tab_3">
                            ...
                            <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                                <div class="d-flex flex-column flex-lg-row gap-2">
                                    <a class="btn btn-sm btn-light-primary fw-bold"
                                       href="../stocks/show_all_stocks.php">Show All Existed Stocks</a>
                                    <a title='Add Stocks' data-bs-toggle='modal'
                                       data-bs-target='#modal-lg-1'
                                       class="btn btn-sm btn-light-success fw-bold"
                                       href="../stocks/add_stocks_form2.php">Add Stocks</a>

                                    <a class="btn btn-sm btn-light-danger fw-bold" href="../stocks/show_deleted_stocks.php">Show
                                        Deleted Stocks</a>
                                </div>
                                <div class="d-flex flex-column flex-lg-row gap-2">
                        ...
                        <div class="tab-pane fade" id="kt_header_navs_tab_4">
                            ...
                            <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                                <div class="d-flex flex-column flex-lg-row gap-2">
                                    <a class="btn btn-sm btn-light-primary fw-bold"
                                       href="../customers/customers_table.php">Show Customers</a>
                                    <a class="btn btn-sm btn-light-success fw-bold"
                                       title='Customer Sign Up' data-bs-toggle='modal'
                                       data-bs-target='#modal-lg-1'
                                       href="../customers/add_customer.php">Sign Up A Customers</a>

                                    <a class="btn btn-sm btn-light-danger fw-bold" href="../customers/show_deleted_customers.php">Show
                                        Deleted Customers</a>
                                </div>
                                <div class="d-flex flex-column flex-lg-row gap-2">
                                    <a class="btn btn-sm btn-light-info fw-bold"
