<x-panel>
                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form id="update_user_password">
                            ...
                            <div class="text-center mb-11">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder mb-3">Change Account Password</h1>
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input name="email" type="text"  value="{{$user->email}}" autocomplete="off" class="form-control bg-transparent"readonly/>
                            </div>
                            <!--begin::Input group=-->

                            <div class="fv-row mb-8">
                                <div class="text-muted">New Password:</div>
                                <input name="new_password" type="password" autocomplete="off" class="form-control bg-transparent"/>
                            </div>
                            <!--begin::Input group=-->

                            <div class="fv-row mb-8">
                                <div class="text-muted">Old Password:</div>
                                <input name="old_password" type="password" autocomplete="off" class="form-control bg-transparent"/>
                            </div>
                            <!--begin::Input group=-->
                            ...
                            <div class="d-grid mb-10">
                                <x-form.button>Update Account Password</x-form.button>
                            </div>
                            <!--end::Submit button-->
    ...
    <script>
        var formId = '#update_user_password';  // Setup form id variable with # here
        ...
        $(formId).submit(function(event){
            ...
            $.ajax({
                url: "{{route('user.password.update', auth()->user()->id)}}",
                method: "POST",
                dataType: "json",
