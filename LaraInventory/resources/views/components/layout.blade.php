                ...
                <div class="align-self-end overflow-auto " id="kt_brand_tabs">
                    ...
                    <div class="header-tabs overflow-auto mx-4 ms-lg-10 mb-5 mb-lg-0" id="kt_header_tabs" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_header_navs_wrapper', lg: '#kt_brand_tabs'}">
                        ...
                        <ul class="nav flex-nowrap text-nowrap">
                            <li>
                                <a href='{{route('product.search')}}'> <span class="mx-5">Products</span>
                                </a>
                            </li>

                            <li>
                                <a href='{{route('stock.search')}}'><span class="mx-5">Stocks</span>
                                </a>
                            </li>

                            <li>
                                <a href='{{route('customer.search')}}'><span class="mx-5">Customers</span>
                                </a>
                            </li>

                            <li>
                                <a href='{{route('stock.in_stock')}}'><span class="mx-5">Sell Stock</span>
                                </a>
                            </li>
...
{{--                        <ul class="nav flex-nowrap text-nowrap">--}}
{{--                            <li class="nav-item">--}}
{{--                                <a class="nav-link" data-bs-toggle="tab" href="#kt_header_navs_tab_2">Products</a>--}}
{{--                            </li>--}}
{{--                            <li class="nav-item">--}}
{{--                                <a class="nav-link" data-bs-toggle="tab" href="#kt_header_navs_tab_3">Stocks</a>--}}
{{--                            </li>--}}
{{--                            <li class="nav-item">--}}
{{--                                <a class="nav-link" data-bs-toggle="tab" href="#kt_header_navs_tab_4">Customers</a>--}}
{{--                            </li>--}}
{{--                            <li class="nav-item">--}}
                ...
                <div class="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
                    ...
                    <div class="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 px-2 px-md-3" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        ...
                        <div class="symbol symbol-30px symbol-md-40px">
                           Welcome Back! <span class="mx-1">{{ucwords(auth()->user()->name)}}</span>
                        </div>
                        <!--end::Symbol-->
                    </div>
                    <!--end::User info-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="{{route('user.update', auth()->user()->id)}}"
                        ...
                        <div class="menu-item px-5">
                            <a href="{{route('user.password.update', auth()->user()->id)}}"
                               data-bs-toggle='modal'
                               data-bs-target='#modal-lg-1'
                               class="menu-link px-5">Change Password</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item for QR Code-->
                        <div class="menu-item px-5 bg-white" style="display: flex; justify-content: center; align-items: center; height: 100%;">
{{--                            @php--}}
{{--                                $userId = auth()->user()->id;--}}
...
{{--                            @endphp--}}
                            ...
                            {{--                            <img src="data:image/png,{!! (new \Milon\Barcode\DNS2D)->getBarcodePNG(--}}
                            {{--    $qrCodeData,--}}
                            {{--    'QRCODE',--}}
                            {{--    5, // Set the width (in pixels) to your desired size--}}
                            {{--    5  // Set the height (in pixels) to your desired size--}}
                            {{--) !!}" alt="QR code" />--}}
{{--                            <img src="data:image/png;base64,{{DNS2D::getBarcodePNG("User ID: $userId | User Email: $userEmail",'QRCODE',--}}
{{--5, // Set the width (in pixels) to your desired size--}}
{{--5, // Set the height (in pixels) to your desired size--}}
{{--array(0,0,0), // Set the foreground color (black)--}}
{{--true // Return the image as a base64-encoded string--}}
{{--)}}" alt="QR code"/><br><br>--}}
                            <img src="{{ asset('storage/qr_codes/user/qrcode_'.auth()->user()->id.'.png') }}" alt="QR code" />

                        </div>
                        <!--end::Menu item for QR Code-->

                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <form method="POST" action="/logout" class="menu-link px-5">
                                @csrf
            ...
            <div class="d-lg-flex flex-column justify-content-lg-center w-100" id="kt_header_navs_wrapper">
                ...
                <div class="tab-content" data-kt-scroll="true" data-kt-scroll-activate="{default: true, lg: false}" data-kt-scroll-height="auto" data-kt-scroll-offset="70px">
                    ...
                    <div class="tab-pane fade" id="kt_header_navs_tab_2">
                        ...
                        <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                <a class="btn btn-sm btn-light-primary fw-bold" title='Create Product' data-bs-toggle='modal' data-bs-target='#modal-lg-1' class="menu-link px-5" href="{{route('product.create')}}">Create Product</a>
                    ...
                    <div class="tab-pane fade" id="kt_header_navs_tab_3">
                        ...
                        <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                <a class="btn btn-sm btn-light-primary fw-bold" href={{route('stock.search')}}>Show Active Stocks</a>
                                <a class="btn btn-sm btn-light-success fw-bold" title='Create Stock' data-bs-toggle='modal' data-bs-target='#modal-lg-1' class="menu-link px-5" href="{{route('stock.create')}}">Create Stock</a>
                                <a class="btn btn-sm btn-light-info fw-bold" href={{route('stock.in_stock')}}>Sell Stock</a>
                            </div>
                            <div class="d-flex flex-column flex-lg-row gap-2">
                    ...
                    <div class="tab-pane fade" id="kt_header_navs_tab_4">
                        ...
                        <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                <a class="btn btn-sm btn-light-primary fw-bold" href={{route('customer.search')}}>Show Active Customer</a>
                                <a class="btn btn-sm btn-light-success fw-bold" title='Create Customer' data-bs-toggle='modal' data-bs-target='#modal-lg-1' class="menu-link px-5"  href="{{route('customer.create')}}">Create Customer</a>
                    ...
                    <div class="tab-pane fade" id="kt_header_navs_tab_5">
                        ...
                        <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                ...
                                <a class="btn btn-sm btn-light-danger fw-bold" href="https://preview.keenthemes.com/metronic8/layout-builder.html">Layout Builder</a>
                            </div>
                            <div class="d-flex flex-column flex-lg-row gap-2">
...
<div class="footer py-4 d-flex flex-lg-column bg-gray-200" id="kt_footer">
    <!--begin::Container-->
