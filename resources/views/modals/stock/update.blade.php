                        ...
                        <form id="update_stock" class="mt-10">
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input class="form-control bg-transparent border border-gray-200 p-2 w-full rounded"
                                       ...
                                       name="cost_price"
                                       id="cost_price"
                                       value="{{number_format($stock->cost_price, 2)}}">
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input class="form-control bg-transparent border border-gray-200 p-2 w-full rounded"
                                       ...
                                       name="sell_price"
                                       id="sell_price"
                                       value="{{number_format($stock->sell_price, 2)}}">
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input class="form-control bg-transparent border border-gray-200 p-2 w-full rounded"
                                       ...
                                       name="points"
                                       id="points"
                                       value="{{$stock->points}}"> <!-- Set default value to 0 if old('points_carry') is empty or null -->
