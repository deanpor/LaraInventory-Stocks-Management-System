<x-panel>
            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        <!--begin::Form-->
                        <form id="update_product" class="mt-10">
                            @csrf
                            <!--begin::Heading-->
                            <div class="text-center mb-11">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder mb-3">Edit Product</h1>
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Product Name-->
                                <x-form.input name="id" :value="$product->id" : readonly="old('id', $product->id)"/>
                                <!--end::Product Name-->
                            </div>
                            <!--end::Input wrapper-->
                            <!--begin::Input group=-->
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::UPC-->
                                <x-form.input name="upc" :value="old('upc', $product->upc)"/>
                                <!--end::UPC-->
                            </div>
                            <!--end::Input wrapper-->
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Description-->
                                <x-form.input name="description" :value="old('description', $product->description)"/>
                                <!--end::Description-->
                            </div>
                            <!--end::Input wrapper-->
    ...
    <script>
        var formId = '#update_product';  // Setup form id variable with # here
