<x-panel>
                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form id="update_customer">
                            ...
                            <div class="text-center mb-11">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder mb-3">Update Customer</h1>
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input name="name" type="text"  value="{{$customer->name}}" autocomplete="off" class="form-control bg-transparent"/>
                            </div>
                            <!--begin::Input group=-->
                            <!--begin::Input group=-->
                            <div class="fv-row mb-8">
                                <div class="text-muted">Email:</div>
                                <input name="email" type="text"  value="{{$customer->email}}" autocomplete="off" class="form-control bg-transparent"/>
                            </div>
                            <!--begin::Input group=-->
                            <!--begin::Input group=-->
                            <div class="fv-row mb-8">
                                <div class="text-muted">Contact Number:</div>
                                <input name="contact_number" type="text"  value="{{$customer->contact_number}}" autocomplete="off" class="form-control bg-transparent"/>
                            </div>
                            <!--begin::Input group=-->
                            <!--begin::Input group=-->
                            <div class="fv-row mb-8">
                                <div class="text-muted">Points Carried:</div>
                                <input name="points_carried" type="text"  value="{{$customer->points_rewards}}" autocomplete="off" class="form-control bg-transparent"/>
                            </div>
                            <!--begin::Input group=-->
                            <!--begin::Submit button-->
                            <div class="d-grid mb-10">
                                <x-form.button>Update Customer</x-form.button>
                            </div>
                            <!--end::Submit button-->
    ...
    <script>
        var formId = '#update_customer';  // Setup form id variable with # here
