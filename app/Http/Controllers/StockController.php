...
class StockController extends Controller
{
    ...
    public function stock_sold(Request $request, $id){
        ...
        $customer->points_rewards = $customer->points_rewards + $stock->points;
        $customer->save();
    ...
    public function store(Request $request){
        ...
        if($validator->fails()){
            ...
            for ($x = 0; $x < $request->quantity ; $x++) {
                ...
                $stock->points = $request->points_carry;
    ...
    public function multi_delete(Request $request){
        ...
        $selectedStocks = explode(',', $request->input('selectedStocks'));
        $response = ['status' => 0, 'message' => 'Fail to delete stock.'];
