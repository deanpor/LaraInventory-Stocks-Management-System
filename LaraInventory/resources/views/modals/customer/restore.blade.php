<x-panel>
            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        <!--begin::Form-->
                        <form id="restore_customer">
                            @csrf
                            <!--begin::Heading-->
                            <div class="text-center mb-11">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder mb-3">Restore Customer</h1>
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input name="deleted_at" type="text"  value="{{$customer->deleted_at}}" autocomplete="off" class="form-control bg-transparent" readonly/>
                            </div>
                            <!--begin::Input group=-->
                            <!--begin::Input group=-->
                            <div class="fv-row mb-8">
                                <div class="text-muted">Deleted By:</div>
                                <input name="deleted_by" type="text"  value="{{$customer->DeletedBy->name}}" autocomplete="off" class="form-control bg-transparent" readonly/>
                            </div>
                            <!--begin::Input group=-->
                            <!--begin::Submit button-->
                            <div class="d-grid mb-10">
                                <x-form.button>Restore Customer</x-form.button>
                            </div>
                            <!--end::Submit button-->
    ...
    <script>
        var formId = '#restore_customer';  // Setup form id variable with # here
        ...
        $(formId).submit(function(event){
            ...
            Swal.fire({
                ...
                if(result.isConfirmed){
                    ...
                    $.ajax({
                        url: "{{route('customer.restore', $customer->id)}}",
                        method: "POST",
                        dataType: "json",
                        ...
                        success: function(response) {
                            if(response['status'] == 1) {
                                ...
                                setTimeout(function () {
                                    window.location.href ="{{route('customer.deleted')}}";
